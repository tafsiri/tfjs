...
(function (global, factory) {
    ...
    ***************************************************************************** */
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!(config.validationData instanceof Dataset)) return [3, 3];
                    ...
                    case 11:
                        ...
                        valOuts = void 0;
                        if (!(config.validationData instanceof Dataset)) return [3, 13];
                        _b = toList;
    ...
    function evaluateDataset(model, dataset, config) {
        return __awaiter(this, void 0, void 0, function () {
            var f, outs, dataIterator, _a, numExamples, _loop_1, batch, state_1, _loop_2, i;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(dataset instanceof LazyIterator)) return [3, 1];
                        _a = dataset;
                        return [3, 3];
                                ...
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        _loop_3 = function (i) {
                                            ...
                                            outs[i] = tfc.tidy(function () { return tfc.add(outs[i], tfc.mul(getScalar(batchSize), batchOut)); });
                                            if (batch > 0) {
